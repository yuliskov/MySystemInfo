...
namespace MySystemInfo
{
   ...
   //          textBox3.VerticalScrollBarVisibility = ScrollBarVisibility.Auto;
   //          textBox3.IsReadOnly = true;
   //          textBox4.TextWrapping = TextWrapping.Wrap;
   //          textBox4.VerticalScrollBarVisibility = ScrollBarVisibility.Auto;
   ...
   //
   // /*         //Fill ComboBoxes  //Old Method - Delete
   //          string[] stringHardwareCategories = { "Cooling Device", "Input Device", "Motherboard", "Controller, and Port", "Networking Device Classes", "Power Classes", "Printing Classes", "Telephony Classes", "Video and Monitor Classes" };
   //          int[] intHardware = { 4, 2, 6, 51, 3, 7, 9, 2, 6 };
   //          string[] stringHardwareClasses = { "Win32_Fan", "Win32_HeatPipe", "Win32_Refrigeration", "Win32_TemperatureProbe", "Win32_Keyboard", "Win32_PointingDevice", "Win32_AutochkSetting", "Win32_CDROMDrive", "Win32_DiskDrive", "Win32_FloppyDrive", "Win32_PhysicalMedia", "Win32_TapeDrive", "Win32_1394Controller", "Win32_1394ControllerDevice", "Win32_AllocatedResource", "Win32_AssociatedProcessorMemory", "Win32_BaseBoard", "Win32_BIOS", "Win32_Bus", "Win32_CacheMemory", "Win32_ControllerHasHub", "Win32_DeviceBus", "Win32_DeviceMemoryAddress", "Win32_DeviceSettings", "Win32_DMAChannel", "Win32_FloppyController", "Win32_IDEController", "Win32_IDEControllerDevice", "Win32_InfraredDevice", "Win32_IRQResource", "Win32_MemoryArray", "Win32_MemoryArrayLocation", "Win32_MemoryDevice", "Win32_MemoryDeviceArray", "Win32_MemoryDeviceLocation", "Win32_MotherboardDevice", "Win32_OnBoardDevice", "Win32_ParallelPort", "Win32_PCMCIAController", "Win32_PhysicalMemory", "Win32_PhysicalMemoryArray", "Win32_PhysicalMemoryLocation", "Win32_PNPAllocatedResource", "Win32_PNPDevice", "Win32_PNPEntity", "Win32_PortConnector", "Win32_PortResource", "Win32_Processor", "Win32_SCSIController", "Win32_SCSIControllerDevice", "Win32_SerialPort", "Win32_SerialPortConfiguration", "Win32_SerialPortSetting", "Win32_SMBIOSMemory", "Win32_SoundDevice", "Win32_SystemBIOS", "Win32_SystemDriverPNPEntity", "Win32_SystemEnclosure", "Win32_SystemMemoryResource", "Win32_SystemSlot", "Win32_USBController", "Win32_USBControllerDevice", "Win32_USBHub", "Win32_NetworkAdapter", "Win32_NetworkAdapterConfiguration", "Win32_NetworkAdapterSetting", "Win32_AssociatedBattery", "Win32_Battery", "Win32_CurrentProbe", "Win32_PortableBattery", "Win32_PowerManagementEvent", "Win32_UninterruptiblePowerSupply", "Win32_VoltageProbe", "Win32_DriverForDevice", "Win32_Printer", "Win32_PrinterConfiguration", "Win32_PrinterController", "Win32_PrinterDriver", "Win32_PrinterDriverDll", "Win32_PrinterSetting", "Win32_PrintJob", "Win32_TCPIPPrinterPort", "Win32_POTSModem", "Win32_POTSModemToSerialPort", "Win32_DesktopMonitor", "Win32_DisplayConfiguration", "Win32_DisplayControllerConfiguration", "Win32_VideoConfiguration", "Win32_VideoController", "Win32_VideoSettings" };
   //          int i = 0, j = 0;
   //          comboBox1.Items.Add(stringHardwareCategories[i]);
   //          foreach (string str in stringHardwareClasses)
   //          {
   //              j++;
   //              if (intHardware[i] == j)
   //              {
   ...
   //
   //          //Save Tab
   //          textBlock2.Text = "* If you choose all classes you have to wait for hours and exported file's size will be more than 1GB.";
   //
   //          //About Tab
   //          textBlock1.Text = "Dedicated to opens source community by:\n Yuriy Lyskov\n\n\n\n" +
   //              "Email:  yu.liskov@gmail.com \n\n\n\n Downlaod Source Code:\n" +
   //          "https://github.com/yuliskov/MySystemInfo";
   //          //"\n\n\nThis is just an experimental tool.";
   //      }
        ...
        static string[] stringWin32classes = {"Win32_1394Controller",
